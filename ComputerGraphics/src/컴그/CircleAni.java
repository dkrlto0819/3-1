...
public class CircleAni extends JApplet{
	...
	private Color[] lineColors= { Color.red, Color.green, Color.blue, Color.yellow, Color.white, Color.magenta};
	...
	public void paint(Graphics gc) {
		...
		gc.drawString("2016108251 강재희", 500, 550);
	}
