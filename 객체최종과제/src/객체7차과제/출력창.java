		   ...
		   for (int i = 0; i < 10 ; i++) {
		    ...
		    lb총수입=new Label(Integer.toString(최종수입));
		      ...
		      setLayout(null);
		       ...
		       lb연.setBounds(30, 30, 60, 20);
		       lb월.setBounds(90, 30, 60, 20);
			   lb일.setBounds(150, 30, 60, 20);
			   lb범주.setBounds(210, 30, 60, 20);
			   lb내역.setBounds(270, 30, 60, 20);
			   lb수입.setBounds(330, 30, 60, 20);
			   lb지출.setBounds(390, 30, 60, 20);
			   lb잔액.setBounds(450, 30, 60, 20);
			   lb비고.setBounds(510, 30, 60, 20);
